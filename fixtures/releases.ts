...
type ReleaseDate = Date | null | undefined;
...
const castToDateValues = (
  obj: Record<number, string | null>,
): BrowserRelease => {
...
export const Releases: BrowsersByName = {
  ...
  "Yandex Browser": castToDateValues(YandexBrowser),
  "QQ Browser": castToDateValues(QQBrowser),
} as const;

export const isKnownRelease = (name: BrowserName, major: MajorVersionNumber) =>
  name in Releases && major in Releases[name];
